...
def Arguments():
    ...
    parser.add_argument('--visual_feature_extractor', type=str, default='coca', choices=['resnet','clip', 'coca', 'mvit'],
                        help='clip/coca features for video segments')
    parser.add_argument('--text_feature_extractor', type=str, default='coca', choices=['clip', 'coca', 'bert'],
    ...
    parser.add_argument('--run_id', type=str, default=None, required=False, help='run_id of the model run')
    parser.add_argument('--dataset', type=str, default='all', choices=['adl', 'kit', 'csv', 'all'],
